    ...
    else if (gBattleTypeFlags & BATTLE_TYPE_LEGENDARY)
    {
        switch (GetMonData(&gEnemyParty[0], MON_DATA_SPECIES, NULL))
        {
            case SPECIES_GROUDON:
                ...
                LZDecompressVram(gBattleTerrainTilemap_Cave, (void*)(BG_CHAR_ADDR(28)));
                break;
            case SPECIES_KYOGRE:
                LZDecompressVram(gBattleTerrainAnimTiles_Underwater, (void*)(BG_CHAR_ADDR(1)));
                LZDecompressVram(gBattleTerrainTilemap_Underwater, (void*)(BG_CHAR_ADDR(28)));
                break;
            case SPECIES_RAYQUAZA:
                LZDecompressVram(gBattleTerrainAnimTiles_Rayquaza, (void*)(BG_CHAR_ADDR(1)));
                LZDecompressVram(gBattleTerrainTilemap_Rayquaza, (void*)(BG_CHAR_ADDR(28)));
                break;
        }
    }
    else
